...
module.exports = {
    ...
    WELCOME: {
        ...
        second:
            'Для поиска объектов по фильтрам нажмите «Искать по фильтрам 🔍». Установите подходящие для вас фильтры, после — нажмите «Поиск»!\n' +
            '\n' +
            'Для просмотра всех объектов без ограничений нажмите «Поиск 🔍». \n' +
            '\n' +
